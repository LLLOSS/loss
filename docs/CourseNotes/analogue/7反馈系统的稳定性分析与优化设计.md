...
<img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-10-06_20-40-23.jpg" width="50%">
...
- 如图，搭建教材8.1.4所示的电路
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-10-06_22-54-45.jpg" width="90%">
...
<img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-10-06_23-00-47.jpg">
...
- 按照教材设定的AC仿真参数仿真，得到的闭环传递函数的波特图如下
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-10-06_23-46-20.jpg">
...
- 将$\beta$适当上调为0.15，仿真得到的闭环传递函数的波特图幅频曲线上出现尖峰，从侧面证明理论求解的$\beta$ 是正确的。
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-10-06_23-51-35.jpg">
...
- 对开环传递函数观察，相位裕度为25度，剪切频率为4.3MHz。
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-10-07_00-04-58.jpg">

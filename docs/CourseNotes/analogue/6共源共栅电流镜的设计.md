...
<img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedimage.png" width="50%">
<p align="center">
图1：共源共栅电流镜
</p>
...
<img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-09-22_19-59-02.jpg">
<p align="center">
图2：原始电流
</p>
...
- 对题目要求的$V_{B}$(在图2中为v0，也即vdc)，进行DC扫描，以$I_{out}-100uA$作为输出，参数设置和仿真图像分别如图3和图4
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-09-22_20-05-59.jpg"  width="40%">
<p align="center">
图3：DC仿真参数
</p>


  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedded4ad38-5761-4f9d-a4e0-6b0b6b1f5cbb.png">
<p align="center">
...
- 对于$V_{B}$的下限，通过对$V_{B}$为1V时的op仿真，发现会使靠下的两个管子M1,M2处于线性区。考虑$V_{B}$在1.1V,1.2V,1.3V,及以后的点挨个仿真，发现1.2V以后，M1,M2成功进入饱和区，$V_{B}$=1.2V的op仿真结果如下：
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-09-22_21-10-20.jpg" width="90%">
<p align="center">
...
- 对于$V_{B}$的上限，从图中较难估计出来。首先考虑$V_{B}$在1.3V,1.4V，1.5V，1.6V，1.7V这几个固定点进行op仿真，发现在1.6V及以后，mos管出现进入线性区的情况。如下图
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefined405749ff-f1e5-4af9-ab9c-d05d59b944d6.png" width="90%">
<p align="center">
...
<div align="center">
    <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedSnipaste_2024-09-22_20-49-57.jpg" width="90%">
<p align="center">
...
- 向AI求助，结果如下：
  ...
  <img src="https://picgo-loss.oss-cn-beijing.aliyuncs.com/undefinedchat_screenshot%20(3)(1).png" width="100%">
<p align="center">
图8：AI的解释
</p>
